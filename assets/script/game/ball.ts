...
import { _decorator, Component, Node, Touch, EventTouch, Vec3, Label, Prefab, ParticleSystem, Animation, Camera, ParticleUtils, find, MeshRenderer,Texture2D } from "cc";
...
export class Ball extends Component {
    ...
    bgtexture1: Texture2D=null!;
    
    @property({type: Texture2D })
    bgtexture2: Texture2D=null!;
    ...
    start () {
        ...
        Constants.game.node.on(Constants.GAME_EVENT.CONTINUELEVEL, this.gameStart, this);
    ...
    activeCurrBoard(_boardList:Array<any>) {
        const pos = this.node.position;
